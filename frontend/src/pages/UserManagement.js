    ...
    return (
      <div className="p-6">
        <div className="bg-white border border-[#E2E8F0] rounded-lg p-6 text-center">
          <p className="text-[#64748B]">Access denied. Only Admin can manage users.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6" data-testid="users-page">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-display font-black text-[#0F172A] mb-2">User Management</h1>
          <p className="text-[#64748B] font-body">Manage system users and roles</p>
        </div>
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-lg shadow-sm p-6 mb-6">
        <h2 className="text-lg font-bold text-[#0F172A] mb-1">Base Proposal Template</h2>
        ...
        <div className="flex items-center gap-4">
          <label
            ...
            className="flex items-center gap-2 px-4 py-2 border border-[#E2E8F0] rounded hover:bg-[#F1F5F9] cursor-pointer transition-colors"
          >
            <Upload size={18} />
          ...
          <table className="w-full">
            <thead className="border-b border-[#E2E8F0] bg-[#F8FAFC]">
              <tr className="text-left">
                <th className="p-4 text-xs uppercase tracking-wider text-[#64748B] font-semibold">Name</th>
                <th className="p-4 text-xs uppercase tracking-wider text-[#64748B] font-semibold">Email</th>
                <th className="p-4 text-xs uppercase tracking-wider text-[#64748B] font-semibold">Role</th>
                <th className="p-4 text-xs uppercase tracking-wider text-[#64748B] font-semibold">Department</th>
                <th className="p-4 text-xs uppercase tracking-wider text-[#64748B] font-semibold">Created</th>
                <th className="p-4 text-xs uppercase tracking-wider text-[#64748B] font-semibold">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#E2E8F0]">
              {users.map((u) => (
                <tr key={u.id} data-testid={`user-row-${u.id}`} className="hover:bg-[#F1F5F9] transition-colors">
                  <td className="p-4 font-medium text-[#0F172A]">{u.name}</td>
                  ...
                  <td className="p-4">
                    <span className="inline-block px-3 py-1 text-xs font-medium bg-[#F1F5F9] text-[#475569] rounded-full">
                      {u.department || 'N/A'}
                    </span>
                  </td>
      ...
      <Dialog open={editRoleOpen} onOpenChange={setEditRoleOpen}>
        <DialogContent className="bg-white">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-sm text-[#64748B] mb-2">User: <span className="font-semibold text-[#0F172A]">{selectedUser?.name}</span></p>
              <p className="text-sm text-[#64748B]">Email: <span className="font-semibold text-[#0F172A]">{selectedUser?.email}</span></p>
            </div>
            <div className="space-y-2">
